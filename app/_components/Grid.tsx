  ...
  return (
    <div className="bg-[#24180c] md:p-6 p-2 max-md:py-6">
      <div className="flex flex-col items-center justify-center md:gap-3 md:pb-6 pb-3 ">
        <h1 className="text-gray-200 font-normal md:text-6xl text-5xl">CATEGORIES</h1>
        <h2 className="text-gray-200 md:text-2xl text-lg">These are the categories</h2>
      </div>

      <div className="grid md:grid-cols-3 grid-cols-2 md:grid-rows-2 grid-rows-6 md:gap-4 gap-2 h-[80vh]">
    
        <div className="md:row-span-2 row-span-3 relative">
          <Image
            src={img1}
            alt="Gents"
        ...
        <div className="max-md:col-span-2 max-md:row-span-2 col-span-1 relative">
          <Image
            src={img3} alt="Daily" className="w-full h-full object-cover"/>
          <div className="absolute bottom-3 left-3 md:text-2xl bg-[#24180c] px-3 py-1 text-gray-200  opacity-50">
            SNEAKERS
          </div>
        </div>
        <div className="max-md:col-span-2 relative col-span-1">
          <Image src={img2} alt="Sale" className="w-full h-full object-cover hidden md:block" />
          <Image src={img5} alt="Sale" className="w-full h-full object-cover block md:hidden" />
          <div className="absolute bottom-3 left-3 md:text-2xl bg-[#24180c] px-3 py-1 text-gray-200  opacity-50">
            BELTS
          </div>
        </div>
